class Point:
    ...
    def equals(self, other):
        ...
        return 8 > abs(self._x - other.get_x()) and 8 > abs(self._y - other.get_y())
        
        
        
        #gave this boolean a tolerance value. If the x and y are within the range of the tolerance, they are considered equal.
